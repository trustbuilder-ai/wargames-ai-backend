...
class Challenges(SQLModel, table=True):
    ...
    system_prompt: str | None = Field(
        default=None, sa_column=Column("system_prompt", Text)
    )
    initial_llm_prompt: str | None = Field(
        default=None, sa_column=Column("initial_llm_prompt", Text)
    )
...
class UserChallengeContexts(SQLModel, table=True):
    ...
    challenge_evaluations: list["ChallengeEvaluations"] = Relationship(
        back_populates="user_challenge_context"
    )
    user_challenge_context_messages: list["UserChallengeContextMessages"] = (
        Relationship(back_populates="user_challenge_context")
    )
...
class ChallengeEvaluations(SQLModel, table=True):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["user_challenge_contexts.id"],
            ondelete="CASCADE",
            name="challenge_evaluation_user_challenge_context_id_fkey",
        ),
    ...
    user_challenge_context_id: int | None = Field(
        default=None, sa_column=Column("user_challenge_context_id", Integer)
    )
    processed_at: datetime | None = Field(
        default=None, sa_column=Column("processed_at", DateTime(True))
    )

    user_challenge_context: Optional["UserChallengeContexts"] = Relationship(
...
class UserChallengeContextMessages(SQLModel, table=True):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["user_challenge_contexts.id"],
            ondelete="CASCADE",
            name="user_challenge_context_messages_user_challenge_context_id_fkey",
        ),
    ...
    user_challenge_context_id: int = Field(
        sa_column=Column("user_challenge_context_id", Integer)
    )
    ...
    user_challenge_context: Optional["UserChallengeContexts"] = Relationship(
        back_populates="user_challenge_context_messages"
    )
