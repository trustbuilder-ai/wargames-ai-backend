...
class RedTeamAttempt:
    ...
    malicious_tool_called: str | None = None
...
class RedTeamResult:
    ...
    malicious_tool_called: str | None
    ...
    def to_report(self) -> dict:
        ...
        return {
            ...
            "attempts_before_success": len(self.attempts)
...
class RedTeamAgent(LLMAgent):
    ...
    async def red_team_session(
        ...
        if system_prompt:
            messages.append(ChatMessageWithTools(role="system", content=system_prompt))
        ...
        for attempt_num in range(1, self.max_attempts + 1):
            ...
            # Add user message
            messages.append(ChatMessageWithTools(role="user", content=user_prompt))
            ...
            if malicious_tool_called:
                ...
                print("🛑 Stopping session - attack succeeded")
                print(f"{'=' * 60}")
        ...
        print(f"\n{'=' * 60}")
        print("✅ Session complete - no malicious tools called")
